...
0 sys*read unsigned int fd char *buf size*t count
1 sys_write unsigned int fd const char *buf size*t count
...
248 sys_add_key const char _\_type const char _\_description const void \_\_payload size*t plen

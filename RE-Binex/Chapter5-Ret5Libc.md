...
Tujuan kita adalah mengarahkan alur program (RIP) untuk melompat ke system() dengan argumen string "/bin/sh".
...
Gadget pop rdi; ret: Instruksi kecil untuk mengambil alamat dari stack ke register RDI.

Alamat /bin/sh: String yang ada di dalam memori libc.

Alamat system(): Alamat fungsi di dalam libc.

Ret Gadget (Alignment): Satu instruksi ret tambahan untuk memenuhi syarat stack alignment 16-byte (menghindari crash MOVAPS).
